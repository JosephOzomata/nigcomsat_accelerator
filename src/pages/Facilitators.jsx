...
const Facilitators = () => {
  const { data: facilitators, loading } = useFirestoreCollection('facilitators');
  ...
  const grouped = useMemo(() => {
    ...
    const orphan = { title: 'Other Facilitators', items: [] };
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
            ...
            <p className="text-lg text-gray-600 max-w-2xl">
              The trainers, coaches, and subject-matter experts leading sessions
              across our cohorts.
            </p>
          </motion.div>
        </div>
      ...
      <div className="min-h-screen bg-white flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 py-24 text-center">
          ...
          <p className="text-gray-500 text-sm">No facilitators published yet.</p>
        </div>
      ) : (
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="mb-8">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  {group.items.length} facilitator{group.items.length !== 1 ? 's' : ''}
                </p>
              </div>
